...
-  Donnez-lui les spécifications suivantes :
    ...
    - **Attention** : Vos trois disques (3) doivent être en provisionnement dynamique. Regardez l'image du provisionnement dynamique en <a href="Images/DisqueDynamique.png">anglais</a> ou en français selon la langue de votre vSphere :  <a href="Images/DisqueDynamiqueFr.png">français</a> pour bien configurer vos disques. Au besoin, demander de l'aide.
