...
- Donnez-lui les spécifications suivantes :
  ...
  - **Attention** : Vos trois disques (3) doivent être en provisionnement dynamique. Regardez l'image du provisionnement dynamique en <a href="Images/DisqueDynamique.png">englais</a> en <a href="Images/DisqueDynamiqueFr.png">francais</a>
