#  Docker - Exercice 4 : Démarrez avec Docker Compose 
...
Modifiez le message d'accueil dans app.py et enregistrez-le. Par exemple, remplacez le message Hello World ! par Hello from Docker !
