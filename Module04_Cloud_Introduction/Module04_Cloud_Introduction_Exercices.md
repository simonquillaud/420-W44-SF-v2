...
- Créez un nouveau compte de stockage :
  - Créez un nouveau groupe de ressources :
    - Exécutez la commande `az group create --name "M04-Ex02-T03" --location "canadaeast" --tags "cohorte=4394" "session=H23" "cours=420-W44-SF" "module=M04"`
...
- Créez la VM avec la commande `az vm create --resource-group "M04-Ex04-T02" --name "M04-Ex04-T02-VM" --image "UbuntuLTS" --size "Standard_B1ls" --admin-username "adminuser" --admin-password "Password123.." --public-ip-sku Basic --location "canadaeast" --tags "cohorte=4394" "session=H23" "cours=420-W44-SF" "module=M04"` (Si vous utilisez un autre groupe de ressources, n'oubliez pas de le changer dans la commande)
...
```bash
az group create --name M04-Ex04-T02 --location canadaeast --tags "cohorte=4394" "session=H23" "cours=420-W44-SF" "module=M04"
```
...
- Créez un nouveau groupe de ressources. Utilisez la commande précédente pour créer un nouveau groupe de ressources nommé "M04-Ex05-T02", utilisez la ligne de commande `az group create --name M04-Ex06-T01 --location canadacentral --tags "cohorte=4394" "session=H23" "cours=420-W44-SF" "module=M04"`
